...
**Plans**: 4 plans
Plans:
- [x] 07-01-PLAN.md — Backend image-resolve: VehicleImageService (CarImages, key server-side, in-memory cache, AbortSignal.timeout, never-throw) + JWT-guarded GET /vehicles/catalog/image + .env.example + unit/e2e (Wave 1)
- [x] 07-02-PLAN.md — Web showroom v2: VehicleImage atom (photo-or-brand-placeholder) + designed garage/add cards + simpler search/nav, Phase-4 server search preserved (Wave 2)
- [x] 07-03-PLAN.md — Mobile showroom v2: RN VehicleImage + designed catalog cards + simpler search, Phase-4 server search preserved (Wave 2)
